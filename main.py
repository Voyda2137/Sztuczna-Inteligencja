...
num_iterations3 = 150
num_cities = 50
alpha = 0.1 # skłonność mrówki do podążania za śladem feromonowym
beta = 0.1 # im wyższa wartość tym bliższe miasto mrówka będzie wybierała
rho = 0.9 # współczynnik parowania feromonów
initial_pheromone = 0.1 # początkowa wartość feromonu
...
connected_results.append(results1)
start = time.perf_counter()
...
connected_results.append(results2)
...
connected_results.append(results3)
...
connected_results.append(results4)
...
connected_results.append(results5)
...
connected_results.append(results6)
...
connected_results.append(results7)
...
connected_results.append(results8)
...
connected_results.append(results9)
with open('connectedResults.csv', 'w', newline='') as file:
    writer = csv.writer(file)
    for arr in connected_results:
        writer.writerow(arr)
...
print(f"Execution time array: {arr}")
